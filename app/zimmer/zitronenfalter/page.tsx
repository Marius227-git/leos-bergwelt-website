          ...
          <div className="mx-auto max-w-7xl px-6 md:px-10">
            <div className="grid gap-12 lg:grid-cols-2">
              ...
              <div className="text-[#3D2817]">
                <h2 className="font-serif text-3xl font-bold">Willkommen im Zimmer Zitronenfalter</h2>
                
                <p className="mt-6 leading-relaxed">
                  Das Zimmer Zitronenfalter ist die perfekte Wahl für alle, die Wert auf ein gutes Preis-Leistungs-Verhältnis legen, ohne dabei auf Komfort und Stil verzichten zu müssen. Mit viel Liebe zum Detail eingerichtet, bietet es dir alles, was du für einen erholsamen Aufenthalt brauchst.
                </p>
                ...
                <p className="mt-4 leading-relaxed">
                  🛏️ Das Zimmer Zitronenfalter bietet Platz für 2 Personen und ist mit einem bequemen Doppelbett ausgestattet.
                </p>
            ...
            <RoomBookingWidget roomName="Zitronenfalter" />
