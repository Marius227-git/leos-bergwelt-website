...
const highlightImages = [
  "/images/room_steinbock/leos_bergwelt_ferienwohnung_oberstdorf_tiefenbach_steinbock_1.webp",
  "/images/room_steinbock/leos_bergwelt_ferienwohnung_oberstdorf_tiefenbach_steinbock_2.webp",
  "/images/room_steinbock/leos_bergwelt_ferienwohnung_oberstdorf_tiefenbach_steinbock_3.webp",
  "/images/room_steinbock/leos_bergwelt_ferienwohnung_oberstdorf_tiefenbach_steinbock_4.webp",
];

const galleryImages = Array.from({ length: 12 }, (_, i) => 
  `/images/room_steinbock/leos_bergwelt_ferienwohnung_oberstdorf_tiefenbach_steinbock_${i + 5}.webp`
);
      ...
      <main className="min-h-screen bg-[#f5eac6] pt-24">
        ...
        <div className="relative h-[50vh] md:h-[60vh]">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 text-white md:p-10">
            <h1 className="font-serif text-4xl font-bold md:text-6xl">Zimmer Steinbock</h1>
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 md:px-10 md:py-24">
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div className="space-y-6 text-[#3D2817]">
              ...
              <div>
                <h2 className="font-serif text-2xl font-bold">🐐 Zimmer Steinbock – hell, gemütlich gemütlich, individuell & nachhaltig mit Bergblick</h2>
                <p className="mt-3 leading-relaxed">
                  Unser Zimmer Steinbock vereint Natürlichkeit mit Komfort: Das Doppelbett und die Möbel wurden liebevoll aus recyceltem Holz selbst gebaut – jedes Stück ist ein Unikat mit Charakter.
                </p>
              </div>
            ...
            {/* Images */}
            <div>
              <ImageLightbox images={highlightImages} alt="Zimmer Steinbock" />
            </div>
          </div>
          ...
          <div className="mt-16">
            ...
            <ImageSlider images={galleryImages} alt="Zimmer Steinbock Galerie" />
          </div>
