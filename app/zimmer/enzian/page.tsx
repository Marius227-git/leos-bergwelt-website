...
const moreImages = Array.from({ length: 8 }, (_, i) =>
  `/images/room_enzian/leos_bergwelt_ferienwohnung_oberstdorf_tiefenbach_enzian_${i + 9}.webp`
);
              ...
              <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4">
                {moreImages.map((image, index) => (
                  ...
                  >
                    <Image
                      src={image}
                      alt={`Zimmer Enzian - weiteres Bild ${index + 1}`}
                      fill
                      className="object-cover transition-transform duration-300 group-hover:scale-105"
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/95" onClick={closeLightbox}>
          ...
          <div className="relative h-[90vh] w-[90vw]" onClick={(e) => e.stopPropagation()}>
            <Image
              ...
              alt={`Zimmer Enzian - Bild ${lightboxIndex + 1}`}
              fill
