...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu - außerhalb des Headers gerendert, um Stacking-Context-Bug zu vermeiden */}
      {mobileMenuOpen && (
        <div
          className={`fixed inset-0 z-[60] bg-[#d8dcc4] lg:hidden ${
        ...
        >
          ...
          <button
            onClick={closeMenu}
            className="absolute right-6 top-6 z-[61] rounded-full bg-white/10 p-2 transition-colors hover:bg-white/20"
